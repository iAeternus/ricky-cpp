...
iris_data = [
    ...
    [6.4,2.8,5.6,2.2,2],[6.3,2.8,5.1,1.5,2],[6.1,2.6,5.6,1.4,2],[7.7,2.8,6.1,2.3,2],
...
with open(os.path.join(OUTPUT_DIR, "classification.csv"), "w") as f:
    for row in iris_data:
        f.write(f"{row[0]},{row[1]},{row[2]},{row[3]},{row[4]}\n")

print(f"Generated {len(iris_data)} Iris samples -> {OUTPUT_DIR}/classification.csv")
