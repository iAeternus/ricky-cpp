...
public:
    ...
    public:
         ...
         * @param curr 当前位置指针
         */
        explicit Iterator(pointer curr = nullptr) :
                curr_(curr) {}
         ...
         * @brief 下标访问
         */
        const_reference operator[](difference_type n) const { return curr_[n]; }
        reference operator[](difference_type n) { return curr_[n]; }
