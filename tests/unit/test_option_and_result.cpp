...
REGISTER_UNIT_TESTS(
    ...
    UNIT_TEST_ITEM(test_option_copy_move),
    UNIT_TEST_ITEM(test_option_unwrap_or),
    UNIT_TEST_ITEM(test_option_map),
    UNIT_TEST_ITEM(test_option_and_then),
    UNIT_TEST_ITEM(test_result_basic),
    UNIT_TEST_ITEM(test_result_copy_move),
    UNIT_TEST_ITEM(test_result_map),
