...
inline auto test_rounding_mode = []() {
    // Given
    // math::BigDecimal bd = ""
};

inline auto test_move_point = []() {
    // Given
    math::BigDecimal bd("123.456789");
...
inline auto test_strip_trailing_zeros = []() {
    // Given
