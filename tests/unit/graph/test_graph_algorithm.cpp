...
REGISTER_UNIT_TESTS(
    ...
    UNIT_TEST_ITEM(test_is_exist_el),
    UNIT_TEST_ITEM(should_bfs),
    UNIT_TEST_ITEM(should_dfs),
    UNIT_TEST_ITEM(test_is_tree),
    UNIT_TEST_ITEM(test_can_reach),
    UNIT_TEST_ITEM(should_get_all_paths),
