...
REGISTER_UNIT_TESTS(
    ...
    UNIT_TEST_ITEM(should_fail_to_construct_by_hour_minute_and_second_if_args_invalid),
    UNIT_TEST_ITEM(should_fail_to_construct_by_second_of_day_if_args_invalid),
    UNIT_TEST_ITEM(should_parse),
    UNIT_TEST_ITEM(should_fetch_now),
    UNIT_TEST_ITEM(should_calc_second_of_day),
    UNIT_TEST_ITEM(should_calc_nanos_of_day),
