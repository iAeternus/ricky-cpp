...
REGISTER_UNIT_TESTS(
    ...
    UNIT_TEST_ITEM(should_construct_with_c_string),
    UNIT_TEST_ITEM(should_fail_to_construct_if_str_invalid),
    UNIT_TEST_ITEM(should_fail_to_construct_if_invalid_char_in_str),
    UNIT_TEST_ITEM(should_judge_odd),
    UNIT_TEST_ITEM(should_left_shift),
    UNIT_TEST_ITEM(should_right_shift),
    UNIT_TEST_ITEM(should_add),
    UNIT_TEST_ITEM(should_subtract),
    UNIT_TEST_ITEM(should_multiply),
    UNIT_TEST_ITEM(should_divide),
    UNIT_TEST_ITEM(should_fail_to_divide_if_divide_by_zero),
    UNIT_TEST_ITEM(should_modulus),
    UNIT_TEST_ITEM(should_power),
